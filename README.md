...
Yes, you can fork this repo. Please give me proper credit by linking back to [abhishek.site](https://abhishek.site/). Thanks!
...
## 📄 License
This project is open source and available under the [MIT License](https://github.com/Abhishek/portfolio-2.0/blob/main/LICENSE).
